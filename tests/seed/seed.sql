...
insert into auth.users (id, email, encrypted_password, confirmation_token, confirmation_token_created_at, email_confirmed_at, created_at, updated_at) values
...
insert into auth.users (id, email, encrypted_password, email_confirmed_at, email_change, email_change_token, email_change_requested_at, encrypted_otp, otp_created_at, created_at, updated_at) values
